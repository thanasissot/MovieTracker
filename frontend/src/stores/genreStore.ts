...
export const useGenreStore = defineStore('genre', {
    ...
    actions: {
        async loadGenres() {
            if (this.initialized && this.genres.length > 0) return
            ...
            try {
                ...
                this.error = err instanceof Error ? err.message : 'Failed to load genres'
        ...
        async addGenre(genreName: string) {
            try {
                ...
                this.error = err instanceof Error ? err.message : 'Failed to add genre'
        ...
        async updateGenre(id: number, genreName: string) {
            try {
                ...
                this.error = err instanceof Error ? err.message : 'Failed to update genre'
        ...
        async deleteGenre(id: number) {
            try {
                ...
                this.error = err instanceof Error ? err.message : 'Failed to delete genre'
